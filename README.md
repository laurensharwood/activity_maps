...
See an example of the three [map outputs](https://laurensharwood.github.io/): i) route heatmap, ii) 3D routes of a user input subset, iii) a heatmap calendar of daily distance or ascent as a Github contributions graph.         
